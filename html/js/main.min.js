...
function checkSafari(){let e=navigator.userAgent.toLowerCase();if(-1!=e.indexOf("safari"))return!(-1<e.indexOf("chrome"))}window.addEventListener("DOMContentLoaded",()=>{var e=document.querySelector(".hero");const t=document.querySelector(".header");console.log(null===e),null===e&&t.classList.add("header_background")});const bodyElement=document.querySelector("body"),htmlElement=document.querySelector("html"),disableScroll=()=>{bodyElement.style.overflow="hidden",htmlElement.style.overflow="hidden"},enableScroll=()=>{bodyElement.style.overflow="visible",htmlElement.style.overflow="visible"},menu=document.querySelector(".menu-box"),burger=document.querySelector(".burger-menu"),lg=window.matchMedia("(max-width: 950px)");function toggleMenu(){menu.classList.contains("open")?(menu.classList.remove("open"),enableScroll()):(menu.classList.add("open"),disableScroll())}!0===lg.matches?(burger.addEventListener("click",toggleMenu),menu.addEventListener("click",toggleMenu)):(burger.removeEventListener("click",toggleMenu),menu.removeEventListener("click",toggleMenu));const select=document.querySelector(".form__select"),selectField=document.querySelector(".form__select-field"),numberOfSlides=(select.addEventListener("change",function(){selectField.textContent=select.value}),document.querySelectorAll(".swiper-slide").length),next=document.querySelector(".history-slider__button_next"),prev=document.querySelector(".history-slider__button_prev"),swiper=(numberOfSlides<=2&&(next.style.pointerEvents="none",prev.style.pointerEvents="none"),console.log(numberOfSlides),new Swiper(".swiper",{slidesPerView:1,breakpoints:{950:{slidesPerView:2}},spaceBetween:24,loop:!0,navigation:{nextEl:".history-slider__button_next",prevEl:".history-slider__button_prev"}}));